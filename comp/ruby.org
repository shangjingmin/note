...
server {
  ...
  root /opt/redmine/redmine-2.1/public; ##一定要到public
  passenger_enabled on;
  passenger_min_instances 3;  # <- Keeps app alive so it always loads fast
  client_max_body_size 100M;  # <- Allow files up to 100MB to be uploaded
}

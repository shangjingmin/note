...
gsettings set com.canonical.Unity.Panel systray-whitelist "['all']"
   ...
   # vc
   sudo apt-get install git bzr gitk qgit gitg

   # human
   # emacs
#    sudo apt-get install ispell iamerican dictionaries-common mew
#    echo "lang en" >> ~/.aspell.conf
#    sudo apt-get install autoconf automake libgtk2.0-dev libxpm-dev libjpeg-dev libgif-dev libtiff4-dev texinfo libtool libncurses-dev
#    ./autogen.sh
